...
void Erase(wstring& input, const wstring& find, bool case_insensitive = false);
void EraseChars(wstring& input, const wchar_t chars[]);
void EraseLeft(wstring& str, const wstring find, bool case_insensitive);
void ErasePunctuation(wstring& input, bool keep_trailing = false);
...
void LimitText(wstring& input, unsigned int limit, const wstring& tail = L"...");
