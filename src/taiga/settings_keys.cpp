...
void Settings::InitKeyMap() const {
  if (key_map_.empty()) {
    key_map_ = {
      ...
      // Episode management
      {AppSettingKey::LibraryManagementDeleteAfterWatch, {"anime/management/delete/afterwatch", false}},
      {AppSettingKey::LibraryManagementDeleteAfterCompletion, {"anime/management/delete/aftercomplete", false}},
      {AppSettingKey::LibraryManagementPromptDelete, {"anime/management/delete/prompt", true}},
      {AppSettingKey::LibraryManagementDeletePermanently, {"anime/management/delete/permanent", false}},
      {AppSettingKey::LibraryManagementKeepNum, {"anime/management/delete/keepnum", 1}},
...
bool Settings::GetManagementDeleteAfterWatching() const {
  return value<bool>(AppSettingKey::LibraryManagementDeleteAfterWatch);
}

void Settings::SetManagementDeleteAfterWatching(const bool enabled) {
  set_value(AppSettingKey::LibraryManagementDeleteAfterWatch, enabled);
}

bool Settings::GetManagementDeleteAfterCompletion() const {
  return value<bool>(AppSettingKey::LibraryManagementDeleteAfterCompletion);
}

void Settings::SetManagementDeleteAfterCompletion(const bool enabled) {
  set_value(AppSettingKey::LibraryManagementDeleteAfterCompletion, enabled);
}

bool Settings::GetManagementPromptDeletion() const {
  return value<bool>(AppSettingKey::LibraryManagementPromptDelete);
}

void Settings::SetManagementPromptDeletion(const bool enabled) {
  set_value(AppSettingKey::LibraryManagementPromptDelete, enabled);
}

bool Settings::GetManagementDeletePermanently() const {
  return value<bool>(AppSettingKey::LibraryManagementDeletePermanently);
}

void Settings::SetManagementDeletePermanently(const bool enabled) {
  set_value(AppSettingKey::LibraryManagementDeletePermanently, enabled);
}

int Settings::GetManagementKeepNum() const {
  return value<int>(AppSettingKey::LibraryManagementKeepNum);
}

void Settings::SetManagementKeepNum(const int number) {
  set_value(AppSettingKey::LibraryManagementKeepNum, number);
}
