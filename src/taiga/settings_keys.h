...
enum class AppSettingKey {
  ...
  // Episode management
  LibraryManagementDeleteAfterWatch,
  LibraryManagementDeleteAfterCompletion,
  LibraryManagementPromptDelete,
  LibraryManagementDeletePermanently,
  LibraryManagementKeepNum,
