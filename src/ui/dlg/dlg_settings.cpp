...
void SettingsDialog::OnOK() {
  ...
  if (page->IsWindow()) {
    taiga::settings.SetManagementDeleteAfterWatching(page->IsDlgButtonChecked(IDC_DELETE_WATCHING));
    taiga::settings.SetManagementDeleteAfterCompletion(page->IsDlgButtonChecked(IDC_DELETE_COMPLETED));
    taiga::settings.SetManagementPromptDeletion(page->IsDlgButtonChecked(IDC_DELETE_PROMPT));
    taiga::settings.SetManagementDeletePermanently(page->IsDlgButtonChecked(IDC_DELETE_PERMANENT));
    taiga::settings.SetManagementKeepNum(static_cast<int>(page->GetDlgItemInt(IDC_DELETE_KEEPNUM)));
  }
